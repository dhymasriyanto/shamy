...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="jenis_pendaftaran">
                                                                <option disabled value="">Pilih</option>
...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="jenis_kelamin">
                                                                <option disabled value="">Pilih</option>
...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input name="nama" required type="text" class="form-control" v-model="tempat_lahir">
{{--                                                            <span style="color: red" class="form-text text-muted">--}}
{{--                                                                **keterangan--}}
{{--                                                            </span>--}}
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input name="nama" required type="date" class="form-control" v-model="tanggal_lahir">
{{--                                                            <span style="color: red" class="form-text text-muted">--}}
{{--                                                                **keterangan--}}
{{--                                                            </span>--}}
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="agama">
                                                                <option disabled value="">Pilih</option>
...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Jenis Pendaftaran</label>
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="editjenis_pendaftaran">
                                                                <option disabled value="">Pilih</option>
                                                                <option value="Peserta didik baru">Peserta didik baru</option>
                                                                <option value="Alih Jenjang">Alih Jenjang</option>
...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Tempat Lahir</label>
                                                        <div class="col-md-9">
                                                            <input name="nama" required type="text" class="form-control" v-model="edittempat_lahir">
{{--                                                            <span style="color: red" class="form-text text-muted">--}}
{{--                                                                **keterangan--}}
{{--                                                            </span>--}}
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Tanggal Lahir</label>
                                                        <div class="col-md-9">
                                                            <input name="nama" required type="date" class="form-control" v-model="edittanggal_lahir">
{{--                                                            <span style="color: red" class="form-text text-muted">--}}
{{--                                                                **keterangan--}}
{{--                                                            </span>--}}
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Agama</label>
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="editagama">
                                                                <option disabled value="">Pilih</option>
                                                                <option value="Islam">Islam</option>
                                                                <option value="Kristen Protestan">Kristen Protestan</option>
                                                                <option value="Katolik">Katolik</option>
