                                            ...
                                            <div class="modal-body">
                                                <form @submit.prevent="create()" id="formtambah">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input name="nama" required type="text" class="form-control" v-model="tahun_ajaran">
                                            ...
                                            <div class="modal-body">
                                                <form @submit.prevent="update()" id="formedit">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Tahun Ajaran</label>
                                                        <div class="col-md-9">
                                                            <input name="nama" required  id="edittahun_ajaran" type="text" class="form-control" v-model="edittahun_ajaran">
{{--                                                            <span style="color: red" class="form-text text-muted">--}}
{{--                                                                **keterangan--}}
{{--                                                            </span>--}}
                                                        </div>
