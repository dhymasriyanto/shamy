...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="id_fakultas">
                                                                <option disabled value="">Pilih</option>
                                                                <option v-for="fakultas in datafakultas" v-bind:value="fakultas.id">
                                                                    @{{ fakultas.nama }}
                                                                </option>
                                                            </select>
{{--                                                            <span style="color: red" class="form-text text-muted">--}}
...
{{--                                                            </span>--}}
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Fakultas</label>
                                                        <div class="col-md-9">
                                                            <select class="form-control" required v-model="editid_fakultas">
                                                                <option v-for="fakultas in datafakultas" v-bind:value="fakultas.id">
                                                                    @{{ fakultas.nama }}
                                                                </option>
                                                            </select>
