                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a href="/fakultas/tambah/" class="btn btn-dark waves-effect"> <i class="fa fa-plus mr-1"></i>Tambah</a><br><br>
                                        <table id="example" class="table table-bordered table-hover">
                                            ...
                                            <tr v-for="fakultas in datafakultas">
                                                <td>@{{  fakultas.id }}</td>
                                                <td>@{{  fakultas.nama }}</td>
                                                <td><button class="btn btn-danger waves-effect" @click="hapus(fakultas.id)">Hapus
                                                    </button></td>
                                            </tr>
                                            </tbody>
                                        </table>
