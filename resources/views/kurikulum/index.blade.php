            ...
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title">Data Kurikulum</h4>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <table id="example" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <tr v-for="(kurikulum,no) in datakurikulum">
                                                <td>@{{  no+1 }}</td>
                                                <td>@{{  kurikulum.nama }}</td>
                                                <td><button type="button" @click="edit(kurikulum.id)" class="btn btn-success waves-effect waves-light"><i
                                                            class="fa fa-edit mr-1" ></i>Edit</button>
                                                    <button class="btn btn-danger waves-effect" @click="hapusdata(kurikulum.id)"><i
